    ...
    return (
        <div className="container text-center mt-5">
            <div className="jumbotron bg-light p-5">
                <h1 className="display-4">Welcome to MERN Collab Tool </h1>
                <p className="lead">
                    MERN Collab Tool is your go-to platform for seamless real-time collaboration. 
                ...
                <p>
                    ...
                    MERN Collab Tool offers all the features you need to stay productive.
                </p>
                <div className="mt-4">
